...
public class GoogleAuthApp {
 ...
 private RedirectUrlListener listener;
  ...
  private static final Logger LOGGER =
      Logger.getLogger(GoogleAuthApp.class.getName());
  ...
  protected void onAuthorization(AuthorizationCodeRequestUrl authorizationUrl) throws IOException {
	  ...
	  if (listener !=null) listener.notifyUrl(authUrl);
    browse(authUrl);
  }
...
public RedirectUrlListener getListener() {
	return listener;
}

public void setListener(RedirectUrlListener listener) {
